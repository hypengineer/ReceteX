    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicinesUsagePeriods", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "MedicinesUsageTypes",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    RemoteId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicinesUsageTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PrescriptionMedicines_MedicinesUsagePeriods_MedicineUsagePeriodId",
                        column: x => x.MedicineUsagePeriodId,
                        principalTable: "MedicinesUsagePeriods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PrescriptionMedicines_MedicinesUsageTypes_MedicineUsageTypeId",
                        column: x => x.MedicineUsageTypeId,
                        principalTable: "MedicinesUsageTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
